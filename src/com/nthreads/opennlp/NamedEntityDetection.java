...
public class NamedEntityDetection {
    ...
    enum TYPE {person, organization, locations, dates}
    ...
    public static void main(String[] args) {
        ...
        try {
            InputStream modelInputStream = new FileInputStream("models/en-ner-" + TYPE.person + ".bin");
            ...
            Print.print(Span.spansToStrings(spans, tokens));
            for(Span s: spans)
